...
const IS_BAZEL_BUILD = !!process.env.OUTPUT_PATH;
...
const OUTPUT_PATH = IS_BAZEL_BUILD ?  resolve(process.env.OUTPUT_PATH, "generated") : resolve(SRC_PATH, 'generated');
const DOCS_OUTPUT_PATH = resolve(OUTPUT_PATH, 'docs');
const API_SOURCE_PATH = resolve(PROJECT_ROOT, 'packages');

console.log("PROJECT_ROOT: " + PROJECT_ROOT);
console.log("CONTENTS_PATH: " + CONTENTS_PATH);
console.log("GUIDE_EXAMPLES_PATH: " + GUIDE_EXAMPLES_PATH);
...
module.exports = { IS_BAZEL_BUILD, PROJECT_ROOT, AIO_PATH, TEMPLATES_PATH, API_TEMPLATES_PATH, CONTENTS_PATH, GUIDE_EXAMPLES_PATH, SRC_PATH, OUTPUT_PATH, DOCS_OUTPUT_PATH, API_SOURCE_PATH, requireFolder };
